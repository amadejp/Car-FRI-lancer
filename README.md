...
The project serves as a decentralized shared mobility app POC, with which users can lend their own personal car when it is not used or rent other users' cars. 
